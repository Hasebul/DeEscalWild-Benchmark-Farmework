...
```bash
python main.py --stage fetch          # Stage 1: fetch metadata per channel
python main.py --stage merge          # Stage 2: merge into one CSV
python main.py --stage transcribe     # Stage 3: add transcripts
```
